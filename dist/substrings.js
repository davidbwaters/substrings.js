 ...
 */
function check (query, hasResults) {
 ...
 */
function fetch (query, text, results) {
 ...
 */
function getAll (open, close, text) {
 ...
 * @return {Array} An array of substrings
 */
function getOne (open, close, text) {
  const start = init(open, close, text);
